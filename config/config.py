...
class paths:
    ...
    raw_interhuman = 'data/interhuman/motions'
    interhuman_dir = 'data/processed_data/interhuman_test'
    ...
    # two-person uwb real-world dataset:
    multiuwb_dir = 'data/processed_data/GIP-DB/'
    ...
    result_dir = 'output/result'                      # output directory for the evaluation results
...
class IMU_placement:
    vi_mask = torch.tensor([1961, 5424, 1176, 4662, 457, 3021])
