...
from modules.model.S4 import S4Model
...
class SSM_JP_estimator(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.rnn_leaf_joint_mapper = S4Model(d_input=self.input_size,
...
class SSM(BaseModel):
    ...
    def __init__(self, args) -> None:
        ...
        self.rnn4 = S4Model(d_input=self.input_size + joint_set.n_leaf * 3,
                            d_output=24 * 3,
                            d_model=args.n_hidden,
                            n_layers=2,
                            dropout=0.2,
        ...
        self.rnn3 = S4Model(d_input=self.input_size + joint_set.n_leaf * 3,
        ...
        self.rnn5 = S4Model(d_input=self.input_size + joint_set.n_leaf * 3,
                            d_output=2,
                            d_model=32,
                            n_layers=2,
                            dropout=0.2,
